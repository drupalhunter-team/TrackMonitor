...
ScenarioBegin("Cancel write app message test set")

    TestCaseBegin("cancelWriteApplication nominal case")
        ...
        VerifyThat(ret == 0 and val12 == 1 and  val8 == 2, "cancelWriteApplication format valid")
        VerifyThat(val6 == 0, "cancelWriteApplication frame number = 0")
