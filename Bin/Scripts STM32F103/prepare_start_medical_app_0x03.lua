...
ScenarioBegin("Message protocol prepare start medical write")

    TestCaseBegin("prepareStartMedicalApplicationReq")
        ...
        SetUByteInTxBuffer(12, Cmd["prepareStartMedicalApplicationReq"] ) -- Message ID
        SendFrame(13)
        ...
        VerifyThat(ret == 0 and val12 == 0x3 and  val8 == 1, "prepareStartMedicalApplicationReq format valid")
        VerifyThat(val6 == 0, "prepareStartMedicalApplicationReq frame number = 0")
