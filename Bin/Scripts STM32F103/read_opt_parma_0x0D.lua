...
ScenarioBegin("Read operational parameters test set")

    TestCaseBegin("readOperationalParameter nominal case")
        ...
        VerifyThat(ret == 0 and val12 == 1 and  val8 == 2, "readOperationalParameter format valid")
        VerifyThat(val6 == 0, "readOperationalParameter frame number = 0")
