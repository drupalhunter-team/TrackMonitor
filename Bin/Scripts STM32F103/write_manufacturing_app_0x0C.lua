...
ScenarioBegin("Write manufacturing test set")
    TestCaseBegin("writeManufacturingApplication nominal case")
        ...
        SetUByteInTxBuffer(12, Cmd["writeManufacturingApplication"] ) -- Message ID
        ...
        VerifyThat(ret == 0 and val12 == 0xC and  val8 == 1, "writeManufacturingApplication format valid")
        VerifyThat(val6 == 1, "writeManufacturingApplication frame number = 0")
