...
ScenarioBegin("Prepare write manufacturing test set")

    TestCaseBegin("prepareWriteManufacturingApplication wrong size")
        ...
        SetUByteInTxBuffer(12, Cmd["prepareWriteManufacturingApplication"])  -- Message ID
        ...
        VerifyThat(ret != 0  and val12 == Cmd["prepareWriteManufacturingApplication"] and  val8 == 1, "prepareWriteManufacturingApplication format valid")
        VerifyThat(val6 == 0, "prepareWriteManufacturingApplication frame number = 0")

        WaitMs(100)
    TestCaseEnd()

    TestCaseBegin("prepareWriteManufacturingApplication nominal case")
