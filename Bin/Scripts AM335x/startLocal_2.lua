...
ScenarioBegin("Start local")
    ...
    TestCaseBegin("prepare start manufacturing application invalid")
    ...
    TestCaseBegin("prepare start medical application valid")
    ...
    TestCaseBegin("Start manufacturing application without prepare start")

        sendCmdWithoutParams(Address["STM32"], Cmd["startManufacturingApplication"])
    ...
    TestCaseBegin("Start medical application success")

        sendCmdWithoutParams(Address["PC"], Cmd["startMedicalApplication"])
