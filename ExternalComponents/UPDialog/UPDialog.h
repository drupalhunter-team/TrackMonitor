...
#include "UPDialogResource.h"                                        //Resource File containing the Dialog Control ID Values
...
// Ajout BLA
    bool     m_bOverWriteCancelButtonCaption; // Do we have to replace the caption of the cancel button?
    TCHAR    m_szCancelButtonCaption[256];    // New label
// fin ajout
...
// Ajout BLA
    CUPDialog(HWND hParentWnd,LP_CUPDIALOG_USERPROC lpUserProc,LPVOID lpUserProcParam,LPCTSTR lpszDlgTitle=_T("Please Wait.."), LPCSTR lpszCancelButtonCaption = NULL);
// fin ajout
