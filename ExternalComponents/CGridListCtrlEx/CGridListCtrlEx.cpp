...
int CGridListCtrlEx::OnClickEditStart(int nRow, int nCol, CPoint pt, bool bDblClick)
{
    ...
    std::list<int>::iterator it = m_ListColumnDisable.begin();

    it = std::find(m_ListColumnDisable.begin(), m_ListColumnDisable.end(), nCol);
    if( it != m_ListColumnDisable.end() )
    {
        return 0;
    }
...
void CGridListCtrlEx::DisableColumnClick(int nCol)
{
    std::list<int>::iterator it = m_ListColumnDisable.begin();
    it = std::find(m_ListColumnDisable.begin(), m_ListColumnDisable.end(), nCol);
    if( it != m_ListColumnDisable.end() )
   ...
   m_ListColumnDisable.push_back(nCol);
}

void CGridListCtrlEx::EnableColumnClick(int nCol)
{
    m_ListColumnDisable.remove(nCol);
}