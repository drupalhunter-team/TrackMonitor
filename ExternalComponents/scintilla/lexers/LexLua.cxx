...
static void FoldLuaDoc(unsigned int startPos, int length, int /* initStyle */, WordList *[],
	...
	for (unsigned int i = startPos; i < lengthDoc; i++) {
		...
		if ((style == SCE_LUA_WORD) || (style == SCE_LUA_WORD2)) {
			if (ch == 'i' || ch == 'd' || ch == 'f' || ch == 'e' || ch == 'r' || ch == 'u'|| ch == 'T') {
				...
				if ((strcmp(s, "if") == 0) || (strcmp(s, "do") == 0) || (strcmp(s, "function") == 0) || (strcmp(s, "repeat") == 0) || (strcmp(s, "TestCaseBegin") == 0)) {
					levelCurrent++;
				}
				if ((strcmp(s, "end") == 0) || (strcmp(s, "elseif") == 0) || (strcmp(s, "until") == 0) || (strcmp(s, "TestCaseEnd") == 0)) {
					levelCurrent--;
				}
			}
