...
** TeCGraf/PUC-Rio
** Apr 2003
** $Id: tolua.h 82 2014-05-09 15:12:45Z blavier $
*/
...
#define TOLUA_VERSION "tolua 5.1b"
...
TOLUA_API int tolua_isusertypearray 
 (lua_State* L, int lo, char* type, int dim, int def, tolua_Error* err);
...
TOLUA_API void tolua_pushusertype (lua_State* L, void* value, char* type);
...
TOLUA_API void tolua_pushfieldstring (lua_State* L, int lo, int index, char* v);
TOLUA_API void tolua_pushfielduserdata (lua_State* L, int lo, int index, void* v);
TOLUA_API void tolua_pushfieldusertype (lua_State* L, int lo, int index, void* v, char* type);
